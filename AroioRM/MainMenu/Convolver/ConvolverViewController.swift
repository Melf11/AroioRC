...
class ConvolverViewController: UIViewController, CAPSPageMenuDelegate {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        tabBarItem = UITabBarItem(title: "Convolver", image: UIImage(named: "Convolver"), tag: 0)
    ...
    override func viewDidLoad() {
        ...
        let controller0 : UIViewController = UIViewController(nibName: "ConvolverModulViewController", bundle: nil)
        controller0.title = "Bänke"
        controllerArray.append(controller0)
        let controller1 : UIViewController = UIViewController(nibName: "ExplanationsViewController", bundle: nil)
        controller1.title = "Erklärungen"
