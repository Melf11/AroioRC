...
class SystemViewController: UIViewController, CAPSPageMenuDelegate {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        tabBarItem = UITabBarItem(title: "System", image: UIImage(named: "System"), tag: 0)
    ...
    override func viewDidLoad() {
        ...
        let controller0 : UIViewController = UIViewController(nibName: "UpdateViewController", bundle: nil)
        controller0.title = "Update"
        controllerArray.append(controller0)
        let controller1 : UIViewController = UIViewController(nibName: "InformationViewController", bundle: nil)
        controller1.title = "Informationen"
